...
class MyService(win32serviceutil.ServiceFramework):
    _svc_name_ = "_tempservice"  # Geef een naam aan je service
    _svc_display_name_ = "_tempservice"  # Geef een weergavenaam aan je service
    _svc_description_ = "_tempservice"  # Geef een beschrijving van je service
